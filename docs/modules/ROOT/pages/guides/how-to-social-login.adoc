...
TIP: For example, testing locally on port `9001` with a `registrationId` of `google`, your Redirect URI would be `http://localhost:9001/login/oauth2/code/google`. Enter this value as the Redirect URI when setting up the application with your provider.
